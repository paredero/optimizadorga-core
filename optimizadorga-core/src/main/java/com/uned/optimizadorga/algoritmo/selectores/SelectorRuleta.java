...
/*
	 ...
	 * @return
	 */
	private double calcularOffset(Population poblacionInicial) {
		double offset = 0;
	 ...
	 */
	private void giroRuleta(Population poblacion,
			Population poblacionSeleccionados, double[] probabilidadesAcumuladas) {
